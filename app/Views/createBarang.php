								...
								<div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-0 me-lg-2">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="?actBarang=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="?actPengguna=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<div class="card">
										...
										<div class="card-header border-0 pt-6">
											...
											<div class="card-toolbar">
												<!--begin::Form-->
                                                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="/mvc-example/?actBarang=simpan">
                                                    <!--begin::Heading-->
                                                    <!--begin::Title-->
                                                        <h3 class="card-title align-items-start flex-column">
                                                            <span class="card-label fw-bold text-dark">Create New Barang</span>
                                                        </h3><br>
                                                    <!--end::Title-->
                                                    <!--begin::Heading-->
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-8">
                                                        <!--begin::Label-->
                                                        <label for="exampleInputIdBarang" class="form-label fs-6 text-dark">Id Barang</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-lg form-control-solid" type="text" id="exampleInputIdBarang" name="IdBarang" placeholder="Id Barang" autocomplete="off" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-8">
                                                        <!--begin::Label-->
                                                        <label for="exampleInputNamaBarang" class="form-label fs-6 text-dark">Nama Barang</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputNamaBarang" name="NamaBarang" placeholder="Nama Barang" autocomplete="off" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-8">
                                                        <!--begin::Label-->
                                                        <label for="exampleInputKeterangan" class="form-label fs-6 text-dark">Keterangan</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputKeterangan" name="Keterangan" placeholder="Keterangan" autocomplete="off" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-8">
                                                        <!--begin::Label-->
                                                        <label for="exampleInputSatuan" class="form-label fs-6 text-dark">Satuan</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputSatuan" name="Satuan" placeholder="Satuan" autocomplete="off" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-8">
                                                        <!--begin::Label-->
                                                        <label for="exampleInputIdSupplier" class="form-label fs-6 text-dark">Id Supplier</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputIdSupplier" name="IdSupplier" placeholder="Id Supplier"/>
                                                        <!--end::Input-->
                                                    </div>
                                                    <div class="fv-row mb-8">
                                                    <button type="submit" class="btn btn-primary btn-md">Submit</button>
                                                    <a href="/mvc-example/?actBarang=tampil-data" class="btn btn-light btn-md">Back</a>
                                                    </div>
                                                    <!--end::Input group-->
							</form>
							<!--end::Form-->
