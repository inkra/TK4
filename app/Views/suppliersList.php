											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">Supplier List</span>
													</h3>
													<!--end::Title-->
													<!--begin::Actions-->
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															<!--begin::Search-->
															<a href="/mvc-example/app/Views/createSupplier.php" class="btn btn-light btn-sm">Add New Supplier</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<thead>
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-150px">Id Supplier</th>
														...
														<tbody class="fw-bold text-gray-600">
															<?php foreach ($rs as $suppliers => $list): ?>
																<tr>
																	<td><a href="?act=tampil-data&i=<?= $list['IdSupplier'] ?>"><?= $list['IdSupplier'] ?></a></td>
																	<td><?= $list['NamaSupplier'] ?></td>
																	<td><?= $list['NoHpSupplier'] ?></td>
																	<td><?= $list['AlamatSupplier'] ?></td>
																	<td>
																	<a href="mvc-example/?act=update&i=<?= $list['IdSupplier'] ?>">Edit</a> |
																	<a href="mvc-example/?act=delete&i=<?= $list['IdSupplier'] ?>" onclick="return confirm('Are you sure you want to delete this supplier?')">Delete</a>
																	</td>
																</tr>
															<?php endforeach; ?>
														</tbody>
