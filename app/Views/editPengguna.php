								...
								<div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-0 me-lg-2">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="mvc-example/?act=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="mvc-example/?actBarang=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="mvc-example/?actPelanggan=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="mvc-example/?actHakAkses=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="mvc-example/?actPengguna=tampil-data">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div class="app-container container-xxl d-flex flex-row flex-column-fluid">
						...
						<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" form method="post" action="/mvc-example/?actPengguna=update&i=<?= $pengguna['IdPengguna'] ?>">
								<!--begin::Heading-->
								<!--begin::Title-->
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold text-dark">Edit Pengguna</span>
									</h3><br>
								<!--end::Title-->
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputNamaPengguna" name="NamaPengguna" placeholder="Nama Pengguna" value="<?= $pengguna['NamaPengguna'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="password" id="exampleInputPassword" name="Password" placeholder="Password"/>
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputNamaDepan" name="NamaDepan" placeholder="Nama Depan" value="<?= $pengguna['NamaDepan'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputNamaBelakang" name="NamaBelakang" placeholder="Nama Belakang" value="<?= $pengguna['NamaBelakang'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputNoHP" name="NoHP" placeholder="Nomor Telepon" value="<?= $pengguna['NoHP'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputAlamat" name="Alamat" placeholder="Alamat" value="<?= $pengguna['Alamat'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-8">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid" input type="text" id="exampleInputIdAkses" name="IdAkses" placeholder="IdAkses" value="<?= $pengguna['IdAkses'] ?>" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<div class="fv-row mb-8">
