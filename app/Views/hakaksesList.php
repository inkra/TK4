											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">Hak Akses List</span>
													</h3>
													<!--end::Title-->
													<!--begin::Actions-->
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															<!--begin::Search-->
															<a href="/mvc-example/app/Views/createHakAkses.php" class="btn btn-light btn-sm">Add New Hak Akses</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<thead>
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-150px">Id Hak Akses</th>
																<th class="min-w-150px">Nama Akses</th>
														...
														<tbody class="fw-bold text-gray-600">
															<?php foreach ($rs as $HakAkses => $list): ?>
																<tr>
																	<td><a href="?actHakAkses=tampil-data&i=<?= $list['IdAkses'] ?>"><?= $list['IdAkses'] ?></a></td>
																	<td><?= $list['NamaAkses'] ?></td>
																	<td><?= $list['Keterangan'] ?></td>
																	<td>
																	<a href="mvc-example/?actHakAkses=update&i=<?= $list['IdAkses'] ?>">Edit</a> |
																	<a href="mvc-example/?actHakAkses=delete&i=<?= $list['IdAkses'] ?>" onclick="return confirm('Are you sure you want to delete this supplier?')">Delete</a>
																	</td>
																</tr>
															<?php endforeach; ?>
														</tbody>
