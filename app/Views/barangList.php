											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">Barang List</span>
													</h3>
													<!--end::Title-->
													<!--begin::Actions-->
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															<!--begin::Search-->
															<a href="/mvc-example/app/Views/createBarang.php" class="btn btn-light btn-sm">Add New Barang</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<thead>
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-150px">Id Barang</th>
														...
														<tbody class="fw-bold text-gray-600">
															<?php foreach ($rs as $barang => $list): ?>
																<tr>
																	<td><a href="?actBarang=tampil-data&i=<?= $list['IdBarang'] ?>"><?= $list['IdBarang'] ?></a></td>
																	<td><?= $list['NamaBarang'] ?></td>
																	<td><?= $list['Keterangan'] ?></td>
																	<td><?= $list['Satuan'] ?></td>
                                                                    <td><?= $list['NamaSupplier'] ?></td>
																	<td>
																	<a href="mvc-example/?actBarang=update&i=<?= $list['IdBarang'] ?>">Edit</a> |
																	<a href="mvc-example/?actBarang=delete&i=<?= $list['IdBarang'] ?>" onclick="return confirm('Are you sure you want to delete this pelanggan?')">Delete</a>
																	</td>
																</tr>
															<?php endforeach; ?>
														</tbody>
