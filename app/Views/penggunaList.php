											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">Pengguna List</span>
													</h3>
													<!--end::Title-->
													<!--begin::Actions-->
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															<!--begin::Search-->
															<a href="/mvc-example/app/Views/createPengguna.php" class="btn btn-light btn-sm">Add New Pengguna</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<thead>
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-150px">Id Pengguna</th>
																<th class="min-w-150px">Nama Pengguna</th>
																<th class="min-w-150px">Nama Depan</th>
                                                                <th class="min-w-150px">Nama Belakang</th>
														...
														<tbody class="fw-bold text-gray-600">
															<?php foreach ($rs as $pengguna => $list): ?>
																<tr>
                                                                <td><a href="?act=tampil-data&i=<?= $list['IdPengguna'] ?>"><?= $list['IdPengguna'] ?></a></td>
                                                                <td><?= $list['NamaPengguna'] ?></td>
                                                                <td><?= $list['NamaDepan'] ?></td>
                                                                <td><?= $list['NamaBelakang'] ?></td>
                                                                <td><?= $list['NoHP'] ?></td>
                                                                <td><?= $list['Alamat'] ?></td>
                                                                <td><?= $list['NamaAkses'] ?></td> 
																	<td>
																	<a href="mvc-example/?actPengguna=update&i=<?= $list['IdPengguna'] ?>">Edit</a> |
																	<a href="mvc-example/?actPengguna=delete&i=<?= $list['IdPengguna'] ?>" onclick="return confirm('Are you sure you want to delete this pengguna?')">Delete</a>
																	</td>
																</tr>
															<?php endforeach; ?>
														</tbody>
