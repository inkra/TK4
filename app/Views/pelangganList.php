											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<h3 class="card-title align-items-start flex-column">
														<span class="card-label fw-bold text-dark">Pelanggan List</span>
													</h3>
													<!--end::Title-->
													<!--begin::Actions-->
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															<!--begin::Search-->
															<a href="/mvc-example/app/Views/createPelanggan.php" class="btn btn-light btn-sm">Add New Pelanggan</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<thead>
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-150px">Id Pelanggan</th>
														...
														<tbody class="fw-bold text-gray-600">
															<?php foreach ($rs as $pelanggan => $list): ?>
																<tr>
																	<td><a href="?actPelanggan=tampil-data&i=<?= $list['IdPelanggan'] ?>"><?= $list['IdPelanggan'] ?></a></td>
																	<td><?= $list['NamaPelanggan'] ?></td>
																	<td><?= $list['NoHpPelanggan'] ?></td>
																	<td><?= $list['AlamatPelanggan'] ?></td>
																	<td>
																	<a href="mvc-example/?actPelanggan=update&i=<?= $list['IdPelanggan'] ?>">Edit</a> |
																	<a href="mvc-example/?actPelanggan=delete&i=<?= $list['IdPelanggan'] ?>" onclick="return confirm('Are you sure you want to delete this pelanggan?')">Delete</a>
																	</td>
																</tr>
															<?php endforeach; ?>
														</tbody>
